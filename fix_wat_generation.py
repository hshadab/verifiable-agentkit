...
backup_file = f"langchain_service.py.backup.proper.{timestamp}"
shutil.copy("langchain_service.py", backup_file)
print(f"Created backup: {backup_file}")

# Read the original file
content = read_file('langchain_service.py')

# New generate_wat_from_c_analysis function with proper escaping
...
try:
    ...
    print("\nWhat changed:")
    print("- Prime checker now uses real prime checking algorithm with loops")
    print("- Collatz sequence calculator implements the actual algorithm")
    print("- Digital root calculator properly sums digits until single digit")
    print("- Added support for Fibonacci and Factorial")
    print("- Added GCD calculator using Euclidean algorithm")
