#!/bin/bash
# Create a clean working main.rs file with location support

echo "🔧 Creating clean main.rs with location support..."
...
async fn main() {
    ...
    let zkengine_binary = std::env::var("ZKENGINE_BINARY")
        .unwrap_or_else(|_| "/home/hshadab/agentic/zkEngine_dev/wasm_file".to_string());
    let wasm_dir = std::env::var("WASM_DIR")
        .unwrap_or_else(|_| "/home/hshadab/agentic/zkEngine_dev/wasm/zkengine-examples".to_string());
...
echo ""
echo "✅ Created clean main.rs with location support!"
echo ""
echo "🔧 Features included:"
echo "   • Location proof support with city name conversion"
echo "   • Proper bracket matching and syntax"
